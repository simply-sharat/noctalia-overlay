            ...
            Item {
              ...
              Item {
                ...
                Rectangle {
                  ...
                  anchors.bottomMargin: (Settings.data.general.compactLockScreen ? 280 : 360) * Style.uiScaleRatio + (panelComponent.systemStatsVisible ? panelComponent.systemStatsExtraHeight : 0)
